"""
Migration 0017 - Create FleetActivity table with raw SQL
"""
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('api', '0016_fleettruck_current_location_fleettruck_speed_kmh'),
    ]
    ...
    operations = [
        migrations.RunSQL(
            ...
            """,
            reverse_sql="DROP TABLE IF EXISTS fleet_activities CASCADE;"
        ),
    ]
