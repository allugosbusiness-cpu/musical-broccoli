...
# If the file doesn't exist, it assigns a dummy function so the 
# server still boots, but the URL returns a "Not Implemented" message.
# ============================================================
...
def safe_import(module_name, functions):
    imported = {}
    try:
        module = __import__(f'.{module_name}', package='api', level=1)
...
# Map V2 Views to V1 URLs for the frontend
